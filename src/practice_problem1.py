...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        self.contents_original = contents
        self.volume = volume
        self.volume_original = volume
        self.combine = 0
        self.history = []
        self.append = 0
        self.extra = 0
    ...
    def append_string(self, additional_contents):
        ...
        self.extra = self.extra + len(stuff_to_return)
    ...
    def shrink(self, new_volume):
        ...
        if len(self.contents) > self.volume:
            ...
            for k in range(self.volume, len(old)):
                extra = extra + old[k]
        self.extra = self.extra + len(extra)
        return extra
    ...
    def reset(self):
        ...
        self.contents = self.contents_original
